...
#
# Generated by Vivado on Sat Sep 17 14:54:32 PDT 2022
...
set orig_proj_dir "[file normalize "$origin_dir/hardware"]"
...
set obj [get_filesets sources_1]
set_property -name "top" -value "system_block_wrapper" -objects $obj
...
# Proc to create BD system_block
proc cr_bd_system_block { parentCell } {

  # CHANGE DESIGN NAME HERE
  set design_name system_block
...
# End of cr_bd_system_block()
cr_bd_system_block ""
set_property REGISTERED_WITH_MANAGER "1" [get_files system_block.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files system_block.bd ] 

#call make_wrapper to create wrapper files
if { [get_property IS_LOCKED [ get_files -norecurse system_block.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/hardware/Lab3.gen/sources_1/bd/system_block/hdl/system_block_wrapper.v" ]
} else {
  set wrapper_path [make_wrapper -fileset sources_1 -files [ get_files -norecurse system_block.bd] -top]
